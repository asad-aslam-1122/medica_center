...
class CycleSymptoms extends StatefulWidget {
  CycleSymptoms({super.key});

  @override
  State<CycleSymptoms> createState() => _CycleSymptomsState();
}

class _CycleSymptomsState extends State<CycleSymptoms> {
