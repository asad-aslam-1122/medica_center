...
class CycleLength extends StatefulWidget {
  ...
  @override
  State<CycleLength> createState() => _CycleLengthState();
}

class _CycleLengthState extends State<CycleLength> {
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    LocalizationMap.getTranslatedValues("cycle_length"),
                    style: R.textStyles
                ...
                Text(
                  LocalizationMap.getTranslatedValues(
                      "how_many_days_are_in_your_cycle"),
                  style: R.textStyles
        ...
        Container(
          ...
          child: TextFormField(
            ...
            decoration: R.decoration
                .fieldDecoration(hintText: "enter_cycle_length", radius: 40),
          ),
        ),
        SizedBox(
          height: 45,
